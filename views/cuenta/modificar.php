            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="cv-details">
                        <h2 class="section-title">Modificando informacion personal</h2>
                        <?php
                        ...
                        <form action='modificando.php' method='POST'>
                            <div class='row g-3'>
                                <div class='col-auto'>
                                    <label class=''>Modificar su correo</label>
                                </div>
                                <div class='col-auto'>
                                    <label for='corre' class='visually-hidden'>Correo</label>
                            ...
                            <div class='row g-3'>
                                <div class='col-auto'>
                                    <label class=''>Modificar su nombre</label>
                                </div>
                                <div class='col-auto'>
                                    <label for='nombre' class='visually-hidden'>Correo</label>
                            ...
                            <div class='row g-3'>
                                <div class='col-auto'>
                                    <label class=''>Modificar su apellido</label>
                                </div>
                                <div class='col-auto'>
                                    <label for='apellido' class='visually-hidden'>Correo</label>
                            ...
                            <div class='row g-3'>
                                <div class='col-auto'>
                                    <label class=''>Modificar su telefono</label>
                                </div>
                                <div class='col-auto'>
                                    <label for='telefono' class='visually-hidden'>Correo</label>
                                    <input type='text' class='form-control' name='telefono' value='$datos->tel_celular'>
                                </div>
                            </div>
                            <br>
                        ";
