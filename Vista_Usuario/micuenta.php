        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div class="sidebar">
                        <div class="user-info">
                            <a href='./micuenta.php'><img src="../src/imgs/logo_sinfondo.png" alt="Logo de SharkShop"></a>
                            
                        </div>
                        <ul class="account-options">
                            <li><a href="../views/cuenta/modificar.php"><button type="button" class="btn btn-dark">Editar perfil</button></a></li>
                            <li><a href="../views/cuenta/passnew.php"><button type="button" class="btn btn-dark">Cambiar contraseña</button></a></li>
                            <li><a href="../views/cuenta/misventas.php"><button type="button" class="btn btn-dark">Historial de compras</button></a></li>
                        </ul>
                ...
                <div class="col-md-9">
                    <div class="cv-details">
...

                        {
                            ...
                            <p><strong>Telefono:</strong> $datos->tel_celular </p>
