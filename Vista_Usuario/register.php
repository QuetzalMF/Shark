...
<?php
    ...
    <div class="container">
        ...
        <h3>REGISTRO</h3>
        <form action="../views/scripts/regis.php" method="post" id="formIniciar">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="tel_celular" class="form-label">Telefono</label>
                <input type="text" class="form-control" name="tel_celular" placeholder="Escribe tus telefono">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                 <button  type="submit" name='send' onclick="redireccionar()" class="btn btn-success">Registrate</button>
            </div>
        </form>
    </div>
